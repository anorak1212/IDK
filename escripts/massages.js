...
const MENSAJES_INICIALES = [
    " > AMOR",
    " > ES AÑO NUEVO EN MI CORAZÓN //",
    " > UN CRISANTEMO AZUL ESTALLARÁ",
    " > NO IMPORTA SI NO BRILLA PARA SIEMPRE",
    " > TE ASEGURO LO ESTOY DISFRUTANDO",
    " > ES SÁBADO EN LA NOCHE ~",
    " > EL LUGAR ESTÁ LLENO PERO YO ESTOY ARRIBA ",
    " > Y SOLO A TI TE VEO ",
    " > SI ME LO PREGUNTAS...",
    " > ESTAMOS SOLOS EN EL LUGAR",
    " > DONDE TODOS VAN A OLVIDAR QUE TIENEN ALGO //",
    " > SOLO ESTÁN BAILANDO, SEDUCIENDO A OTRAS PERSONAS ~",
    " > TÚ Y YO ESTAMOS BORRACHOS ",
    " > ESPERANDO EL MOMENTO...",
    " > DE IRNOS A TU CASA A OLVIDARNOS DE LAS HORAS ",
];
