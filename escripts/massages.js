...
const MENSAJES_INICIALES = [
    " > MIENTRAS ESTEMOS VIVOS DEBEMOS AMAR LO MAS QUE SE PUEDA",
    " > VALORA CADA SEGUNDO QUE TE DA LA VIDA",
    " > LO QUE YA PASO NO SE PUEDE CAMBIAR SOLAMENTE",
    " > PODEMOS APRENDER DE ESO",
    " > NO TE PREOCUPES TANTO POR LO QUE VA A PASAR",
    " > MEJOR ENFOCATE EN EL AHORA APROVECHA EL MOMENTO",
    " > EL AMOR SIEMPRE VA A SER LA MEJOR OPCION",
    " > https://bit.ly/47q2BfE"
];
